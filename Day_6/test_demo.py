...
# Excel Dosyasindan Data Okumak Icin OpenPyXl Class ini import Etmek Gerekiyor
import openpyxl
...
# Proje Icinde Kulanilacak Ortak Ozelliklerin Ve
# Text Tipinde Yer Alan Data larin Tutulacagi 
# Constants Klasoru Icinden globalConstants Dosyasini import Ediyoruz
...
class Test_Demo:
    ...
    def setup_method(self):
        ...
        # Test Islemi Yapilacak Sitenin Adini
        # Proje Klasoru Icindeki 
        # Constants Klasoru Icindeki 
        # globalConstants Dosyasi Icinde Yer Alan URL Degiskeni
        # Uzerinden Aliyoruz
    ...
    # Data Okunma Islemi Yapilarak Istenilen Yerden
    # Data Cekilebilir

    # Anotasyonlardan Cagirilacak Fonksiyona
    # Self Anahtar Kelimesi Parametre Olarak Verilmez
    def getData():

        # Okunacak Datayi Barindiran Excel Dosyasindan 
        # Datayi Almak Icin Load Workbook Fonksiyonu Icinde
        # Dosyanin Yolunu Belirtiyoruz
        excelFile = openpyxl.load_workbook("data/invalid_login.xlsx")

        # Data Okumanin Excel Dosyasi Icinde
        # Hangi Sayfadan Yapilacagini Belirtiyoruz
        selectedSheet = excelFile["Sayfa1"]

        # Data Okuma Isleminin Yapilacagi Excel Dosyasi Icinde
        # Data Okuma Isleminin Yapilacagi Sayfa Icinde 
        # Data Barindiran Toplam Satir Sayisini Bulmak Gerekiyor
        totalRows = selectedSheet.max_row

        # Bos Bir Tuple Data Olusturuyoruz
        data = []

        # Ecxel Dosyasi Icinde Baslik Olarak Belirtilen Satir Dahil Sonrasini
        # Tarama Islemini Baslatiyoruz
        # Tarama Islemini Data Iceren Satir Sayisi Kadar Devam Ettiriyoeuz
        # Tarama Isleminde Baslik Satirindan Sonrasini Tarama Yapmak Icin
        # Range Fonksiyonunda Ilk Parametreye 2 Degerini Vermek Gerekiyor
        for i in range(2,totalRows+1):

            # Data Cekilecek Excel Dosyasinda Baslik Satirina Erisiyoruz
            # i Olarak Ifade Edilen Baslik Satiri
            username = selectedSheet.cell(i,1).value

            # Data Cekilecek Excel Dosyasinda Sonraki Baslik Satirina Erisiyoruz
            # i Olarak Ifade Edilen Baslik Satiri
            password = selectedSheet.cell(i,2).value

            # int ve String Tipi Gibi 
            # Birbirinden Farkli Degerlerden Olusan
            # Arrayleri Tuple Denilen Array Tipinde
            # Tutmak Gerekiyor
            tubleData = (username,password)

            # Dosyadan Okunan Data yi Append Fonksiyonu Icinde
            # Tuple Tipi Array den Olusan Data lari Parametre Olarak Veriyoruz
            data.append(tubleData)
    ...
    # Dosya Okuma Islemi Yapilmasi Icin
    # Okunacak Dosyayi Fonksiyon Icinden Okumasi Gerekiyor
    # Dosya Okuma Isleminin Yapilacagi Fonksiyon Adini 
    # Ikinci Parametre Olarak Giriyoruz
    @pytest.mark.parametrize("username,password",getData())
    def test_invalid_login(self,username: list,password: list):
