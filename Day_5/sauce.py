...
class Test_SauceDemo:
    ...
    # Her Class ta Kullanilacak Ozellikleri Fonksiyon Haline Getirerek
    # Her Seferinde Ayni Satirlari Yazmaya Gerek Kalmadan
    # Olusturulan Fonksiyona Self Parametresi Uzerinden
    # Islemlerin Atandigi Degisken Adina Ulasiyoruz

    # Test Class larinda Constructor Olusturulmaz
